...
public class Comanda {
    ...
    public Comanda(String client, String oras, String strada, String numarCasa,  Produs produs, Boolean asistenta,String Data) {
    ...
    public String getMobila(){return  Mobila;}
    public String getLemn(){return  Lemn;}
    public int getPret(){return  pret;}
    public long  getId(){return id;}
    public String getNumarCasa(){return  numarCasa;}
    public Boolean getAsistenta(){ return asistenta;}
    ...
    public int hashCode() {
        return Objects.hash(client,oras, strada, numarCasa, Mobila,Lemn,pret,asistenta);
    }
}
